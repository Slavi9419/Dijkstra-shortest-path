...
public class TownsFactory implements GraphFactory {
	...
	private Scanner townVertexStream;
	...
	public SimpleWeightedGraph<String, Double> create() throws FileNotFoundException {
		...
		try {
			townVertexStream = new Scanner(countryVertexStream);
			while (townVertexStream.hasNext()) {
				String line = townVertexStream.next();
	...
	public InputStream getCountryEdges() {
		return countryEdgesStream;
	}
	...
	public InputStream getCountryVertex() {
		return countryVertexStream;
	}
